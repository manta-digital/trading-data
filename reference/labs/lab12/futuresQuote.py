...
# Mapping from json api result to pandas dataframe.  Includes some validation and processing
...
class FuturesQuote:
    ...
    def toDataFrame2(result):
        ...
        for i in result.items():
            ...
            dataFrame = pd.concat((dataFrame, dataAppend), axis=0).reset_index(drop=True)
