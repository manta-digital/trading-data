...
# 2022: update this so interval is a function, just have to make it work with a decent default
...
#
# 2023: added repeatedFunctionTimer but this will not only drift but create a new thread for
# every execution of the timer function.
#
# **********************************************************************************************
# Deprecated.  Used RepeatedThreadTimer instead.
# **********************************************************************************************
...
class RepeatedTimer(object):
    ...
    # still feels annoying that we create a thread every timer interval.  A
    # single threaded worker may be better.  See also:
    # https://stackoverflow.com/questions/45684451/threading-timer5-function-launch-every-5-second
    # https://stackoverflow.com/questions/12435211/threading-timer-repeat-function-every-n-seconds
    # https://stackoverflow.com/questions/5177439/postponing-functions-in-python/14040516#14040516
    #
    # todo: try using the description in the last link to subclass thread and create a repeating function
    def _run(self):
        self.is_running = False
        self.start()
