...
## Decisions ratified by the Project Manager (20260828)
...
- **Decision 3** — ✅ ratified 20260828: trades under the same collection rule (~155 GB/year compressed), settings renamed `MT_KALSHI_COLLECTION_*` with a loud guard for the old names. Free disk confirmed: 990 GB on the database volume. A minimum-lifetime clause for dropping the 15-minute ladders is anticipated after the PM's ~60-day evaluation.
